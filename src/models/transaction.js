...
const column = `${table}.id, ${table}.transaction_id, ${tableStore}.name AS store, ${table}.items_name, ${table}.price, ${table}.qty, ${table}.total_price, ${table}.delivery_fee, ${table}.summary, ${table}.created_at`
