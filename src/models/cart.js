...
const column2  = `${table}.id, ${tableItem}.seller_id, ${tableStore}.name AS store, ${table}.user_id, ${tableDetail}.name AS user, ${tableItem}.name, ${tableItem}.price, ${table}.qty, ${table}.qty*${tableItem}.price AS total`
